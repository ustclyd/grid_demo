...
var conflict2_survivor_unit_ids: Array[int] = []
var conflict2_defeated_unit_ids: Array[int] = []
var teleported_unit_ids: Array[int] = []
var teleport_records: Array[Dictionary] = []
...
var dropped_bag_records: Array[Dictionary] = []
var dropped_bag_ids: Array[int] = []

var forced_stay_unit_ids: Array[int] = []
var portal_ready_unit_ids: Array[int] = []
var portal_ready_records: Array[Dictionary] = []
var exit_ready_unit_ids: Array[int] = []
var exit_ready_records: Array[Dictionary] = []
var exited_unit_ids: Array[int] = []
var exit_records: Array[Dictionary] = []
var exit_refresh_records: Array[Dictionary] = []
